...
func main() {
	...
	conf := config{
		Server: configServer{
			Port: conf2.EnvironmentConfigIns().ServerPort,
		},
		Raft: configRaft{
			NodeId:    conf2.EnvironmentConfigIns().RaftNodeId,
			Port:      conf2.EnvironmentConfigIns().RaftPort,
			VolumeDir: conf2.EnvironmentConfigIns().RaftVolumeDir,
		},
	}
